dashboard "type_installed_errors" {
...
with controls_list as (select id                                              as control_id,
     ...
     mods_resources as (select substr(title, 9) as type_name,
                        ...
                        where filter = 'resourceTypeId:"tmod:@turbot/turbot#/resource/types/actionType","tmod:@turbot/turbot#/resource/types/policyType","tmod:@turbot/turbot#/resource/types/resourceType","tmod:@turbot/turbot#/resource/types/controlType" level:self')
